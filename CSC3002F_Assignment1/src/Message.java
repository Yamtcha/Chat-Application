...
public class Message {
	 ...
	 * @param messageID An Enumeration representing a code which identifies the purpose of the Message. 
	 * @param sourceName The name of the Sender/Source of the Message.
	 * @param destinationName The name of the Receiver/Destination of the Message.
